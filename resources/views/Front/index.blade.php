                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <a href="#courses" class="btn_1"> <View></View> Course </a>
                            <a href="{{route('Admin.login')}}" class="btn_2">Login </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        ...
                        <p>{{__('lang.Set have great you male grass yielding an yielding first their youre
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="single_special_cource">
                            ...
                            <div class="special_cource_text">
                                <a href="{{route('Front.cat',$c->cat_id,)}}" class="btn_4">{{$c->name}}</a>
                                <h4>{{$c->price}}$</h4>
